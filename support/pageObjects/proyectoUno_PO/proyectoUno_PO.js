...
SeccionUno(name, last_name,email,t){
        let tiempo=t
        cy.xpath("//body/div[2]/div[1]/div[2]/section[1]/form[1]/fieldset[1]/div[1]/div[1]/div[1]/input[1]").clear().should("be.visible").type(name)
        cy.screenshot("Campo nombre")
        cy.xpath("//body/div[2]/div[1]/div[2]/section[1]/form[1]/fieldset[1]/div[2]/div[1]/div[1]/input[1]").clear().should("be.visible").type(last_name)
        cy.wait(tiempo)
        cy.xpath("//body/div[2]/div[1]/div[2]/section[1]/form[1]/fieldset[1]/div[3]/div[1]/div[1]/input[1]").clear().should("be.visible").type(email)
}
